...
export class ButtonComponent {
  ...
  get buttonClass(): string {
    const base = 'inline-flex items-center justify-center gap-2 px-4 py-2 font-label-md rounded font-semibold transition-all duration-150 disabled:opacity-50 disabled:cursor-not-allowed';
